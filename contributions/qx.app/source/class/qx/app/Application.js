...
/**
 * This is the main application class of your custom application "qx.app"
 *
 * @asset(qx/app/*)
 */
qx.Class.define("qx.app.Application",
{
  ...
  members :
  {
    ...
    main : function()
    {
      ...
      */
      ...
      // Create a button
      var button1 = new qx.ui.form.Button("First Button", "qx/app/test.png");
